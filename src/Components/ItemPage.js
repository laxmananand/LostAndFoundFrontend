...
function ItemPage(props) {
  ...
  const submitActivate = () => {
    ...
    Axios({
      method: "POST",
      url: `${process.env.URL}/activateItem/${item_id}`,
    })
      .then((res) => {
  ...
  useEffect(() => {
    ...
    Axios({
      url: `${process.env.URL}/item/${item_id}`,
      method: "GET",
    })
      .then((response) => {
  ...
  const submitResponse = () => {
    ...
    Axios({
      url: `${process.env.URL}/confirmResponse/${messageId}`,
      method: "POST",
  ...
  const delete_item = () => {
    console.log("deleted");
    Axios({
      url: `${process.env.URL}/deleteitem`,
      method: "POST",
      data: { item_id },
    })
      .then((response) => {
  ...
  const submitAnswer = () => {
    Axios({
      url: `${process.env.URL}/submitAnswer`,
      method: "POST",
      data: {
        itemId: item_id,
