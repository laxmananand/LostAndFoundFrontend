...
export default function Home() {
  ...
  return (
    <>
      ...
      <div data-aos="fade-right">
        <Container fluid className="total-inspiration">
          ...
          <Row className="inspiration">
            ...
            <p>
              Many college students can relate to the experience of misplacing
              their belongings, such as a new pair of earphones, and feeling
              uncertain about where they may have left them. Despite being a
              common problem, it persists until someone comes up with a
              solution.
            </p>
      ...
      <div className="footer" style={{ backgroundColor: "#a6bac2f0" }}>
        <div className="social-icon">
          ...
          <a
            href="mailto:laxman282000@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <h5 style={{ textAlign: "center" }}>
          Copyright © 2023 IT GROUP 6. All rights reserved.
        </h5>
      </div>
      {/* <div className="About">
        <div>
